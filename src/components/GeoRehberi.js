...
export default function GeoRehberi() {
  return (
    <>
      <Helmet>
        <title>GEO Rehberi | Fatih Emin Çakıroğlu</title>
        <meta name="description" content="Generative Engine Optimization rehberi. AI Overview, Perplexity ve ChatGPT'de kaynak olma stratejileri." />
      </Helmet>
